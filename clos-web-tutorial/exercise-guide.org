...
**Note**: You'll need to either import `generate-id` from the utils package or define it locally. Update your `package.lisp` to include:
#+begin_src lisp
(defpackage #:clos-web.models
  (:use #:cl)
  (:import-from #:clos-web.utils #:generate-id)
  (:export #:task
           #:task-id
           #:task-title
           #:task-description
